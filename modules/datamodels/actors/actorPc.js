...
import {
  characterInitiativesPartialModel 
} from './partial/initiatives.js'
import {
  ...
  static defineSchema() {
    ...
    return {
      ...
      skills: new fields.SchemaField({
        ...
        decompiling: new fields.SchemaField({
          ...baseSkillSchema('resonance', 'socialLimit', 'taskingGroup', 'resonanceSkills', false)
        }),
        registering: new fields.SchemaField({
          ...baseSkillSchema('resonance', 'spriteLevel', 'taskingGroup', 'resonanceSkills', false)
        }),
      }),
      ...
      biography: new fields.SchemaField({
        ...
        dependants: new fields.StringField({
          initial: ''
        }),
        metatype: new fields.StringField({
          initial: ''
        }),
        metatypeVariant: new fields.StringField({
          initial: ''
        }),
        ethnicalGroup: new fields.StringField({
          initial: ''
        }),
      ...
      critterBiography: new fields.SchemaField({
        binomial: new fields.StringField({
          initial: ''
        }),
        terrain: new fields.StringField({
          initial: ''
        }),
        diet: new fields.StringField({
          initial: ''
        }),
        activity: new fields.StringField({
          initial: ''
        }),
        aggroIndex: new fields.StringField({
          initial: ''
        }),
        lengthHeight: new fields.StringField({
          initial: ''
        }),
        mass: new fields.StringField({
          initial: ''
        }),
      }),
      ...
      nuyen: new fields.SchemaField({
        ...sr5ModsPartialModel.defineSchema()
      }),
      streetCred: new fields.SchemaField({
        ...sr5ModsPartialModel.defineSchema()
      }),
      notoriety: new fields.SchemaField({
        ...sr5ModsPartialModel.defineSchema()
      }),
      addictions: new fields.ArrayField(new fields.ObjectField()),
      publicAwareness: new fields.SchemaField({
        ...sr5ModsPartialModel.defineSchema()
      }),
      activeSpecialAttribute: new fields.StringField({
        initial: 'magic'
      }),
    }
  }
